<div class="relative" x-data="{
    ...
    >
       ...
       <span class="block mr-1 font-medium text-theme-sm"><?php echo e(auth()->user()->name ?? 'Usuario'); ?></span>
    ...
    >
        <!-- User Info -->
        <div>
            <span class="block font-medium text-gray-700 text-theme-sm dark:text-gray-400"><?php echo e(auth()->user()->name ?? 'Usuario'); ?></span>
            <span class="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400"><?php echo e(auth()->user()->email ?? ' '); ?></span>
        </div>
...
<?php /**PATH C:\laragon\www\Restaurante\resources\views/components/header/user-dropdown.blade.php ENDPATH**/ ?>