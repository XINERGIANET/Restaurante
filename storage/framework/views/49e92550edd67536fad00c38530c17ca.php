...
<div class="relative" x-data="{
    ...
    <!-- Notification Button -->
    <button
        <?php echo e($attributes->merge(['class' => 'relative flex items-center justify-center text-white transition-all bg-white/10 border border-white/10 rounded-full hover:text-white h-11 w-11 hover:bg-white/20'])); ?>
                ...
                <li @click="handleItemClick()">
                    ...
                    >
                        <span class="relative block w-full h-10 rounded-full z-1 max-w-10">
                            <img src="<?php echo e($notification['userImage']); ?>" alt="User" class="overflow-hidden rounded-full" />
                            <span
                                class="absolute bottom-0 right-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white dark:border-gray-900 <?php echo e($notification['status'] === 'online' ? 'bg-success-500' : 'bg-error-500'); ?>"
                            ></span>
                        </span>
                        ...
                        <span class="block">
                            <span class="mb-1.5 block text-theme-sm text-gray-500 dark:text-gray-400">
                                ...
                                <span class="font-medium text-gray-800 dark:text-white/90">
                                    <?php echo e($notification['project']); ?>
...
<?php /**PATH C:\laragon\www\Restaurante\resources\views/components/header/notification-dropdown.blade.php ENDPATH**/ ?>