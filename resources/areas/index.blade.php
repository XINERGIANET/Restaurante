                            ...
                            <div class="flex items-center justify-center gap-2">
                                <div class="relative group">
                                    ...
                                    <span
                                        ...
                                        style="transition-delay: 0.5s;">Ver mesas</span>
                                </div>
                                <div class="relative group">
                                ...
                                <div class="relative group">
                                    <form method="POST" action="{{ route('areas.destroy', $area) }}"
                                        ...
                                        @csrf
                                        @method('DELETE')
                                        <x-ui.button type="submit" size="icon" variant="danger"
                                    ...
                                    <span
                                        class="pointer-events-none absolute top-full left-1/2 -translate-x-1/2 mt-2 whitespace-nowrap rounded-md bg-gray-900 px-2 py-1 text-xs text-white opacity-0 transition group-hover:opacity-100 z-50"
                                        style="transition-delay: 0.5s;">Eliminar area</span>
                                </div>
                            </div>
                        </td>
                    </tr>
