...
@section('content')
    <div x-data="{}">
            ...
            <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                <form method="GET" class="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <x-ui.link-button size="sm" variant="outline" href="{{ route('admin.sales.index') }}">
                ...
                <x-ui.button size="md" variant="primary" type="button"
                    style=" background-color: #12f00e; color: #111827;" @click="$dispatch('open-sale-modal')">
                    ...
                    <thead>
                        <tr class="border-b border-gray-100 dark:border-gray-800">
                            <th class="px-5 py-3 text-left sm:px-6">
                                <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Numero</p>
                            </th>
                            <th class="px-5 py-3 text-left sm:px-6">
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12">
                                    <div class="flex flex-col items-center gap-3 text-center text-sm text-gray-500">
                                        ...
                                        <x-ui.button size="sm" variant="primary" type="button" @click="$dispatch('open-sale-modal')">
                                            <i class="ri-add-line"></i>
        ...
        <x-ui.modal x-data="{ open: false }" @open-sale-modal.window="open = true" @close-sale-modal.window="open = false" :isOpen="false" :showCloseButton="false" class="max-w-4xl">
            <div class="p-6 sm:p-8">
                <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Registrar venta</h3>
                            <p class="mt-1 text-sm text-gray-500">Ingresa la informacion de la venta.</p>
                        </div>
                    </div>
