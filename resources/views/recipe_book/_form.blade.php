<div x-data="{
    ...
    product_list: {{ \Illuminate\Support\Js::from($ingredientsList) }},
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div x-data='{ 
                        ...
                        products: @json($productsForRecipe),
                    ...
                    <div class="relative">
                        <input type="text" x-model="search" @focus="open = true" @mousedown="open = true"
                            placeholder="Seleccionar producto..."
                            class="h-11 w-full rounded-lg border border-gray-300 bg-white px-4 text-sm text-gray-800 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none dark:border-gray-600 dark:bg-gray-900 dark:text-white transition-all"
                            autocomplete="off">
                ...
                <div>
                    <label class="mb-2 block text-sm font-semibold text-gray-700 dark:text-gray-300">Tiempo
                        (min)</label>
                    <div class="relative">
                        ...
                        <input type="number" name="preparation_time"
                            value="{{ old('preparation_time', data_get($recipe, 'preparation_time')) }}"
                            class="h-11 w-full rounded-lg border border-gray-300 bg-white pl-10 px-4 text-sm text-gray-800 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none dark:border-gray-600 dark:bg-gray-900 dark:text-white transition-all"
                            placeholder="0">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center"
                        ...
                        <input type="number" name="yield_quantity"
                            ...
                            class="h-11 w-24 rounded-l-lg border border-gray-300 bg-white px-3 text-sm text-gray-800 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none dark:border-gray-600 dark:bg-gray-900 dark:text-white z-10"
                            placeholder="1">

                        <div class="relative flex-1">
                            <input type="text" x-model="search" @focus="open = true" @mousedown="open = true"
                                placeholder="Unidad..."
                                class="h-11 w-full rounded-r-lg border border-l-0 border-gray-300 bg-white px-4 text-sm text-gray-800 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none dark:border-gray-600 dark:bg-gray-900 dark:text-white transition-all"
                                autocomplete="off">
                ...
                <div class="col-span-1 md:col-span-2">
                    <label class="mb-2 block text-sm font-semibold text-gray-700 dark:text-gray-300">Descripción /
                        Historia</label>
                    <textarea name="description" rows="3"
                        class="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm text-gray-800 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none dark:border-gray-600 dark:bg-gray-900 dark:text-white resize-none"
                        placeholder="Ej: Versión especial de la casa...">{{ old('description', data_get($recipe, 'description')) }}</textarea>
                </div>
            </div>
        </div>
    </div>
    ...
    <div
        ...
        <div
            ...
            <button type="button" @click="addIngredient()"
                class="h-9 inline-flex items-center gap-2 rounded-lg bg-gray-900 px-4 py-2 text-xs font-semibold text-white shadow-sm hover:bg-gray-800 transition-all dark:bg-blue-600 dark:hover:bg-blue-500">
        ...
        <div class="p-6">
            ...
            <div class="space-y-3">
                <template x-for="(row, index) in ingredients" :key="index">
                    <div
                        class="group grid grid-cols-1 md:grid-cols-12 gap-4 items-center rounded-xl border border-gray-200 bg-white p-3 shadow-sm hover:border-blue-400 hover:shadow-md transition-all dark:border-gray-700 dark:bg-gray-900">
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <input type="number" :name="`ingredients[${index}][quantity]`"
                                x-model="row.quantity" step="0.01"
                                class="h-10 w-full rounded-lg border border-gray-300 bg-white px-3 text-sm text-center text-gray-800 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none dark:border-gray-600 dark:bg-gray-900 dark:text-white"
                                placeholder="1">
                        </div>
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" :name="`ingredients[${index}][unit_cost]`"
                                    x-model="row.unit_cost" step="0.01"
                                    class="h-10 w-full rounded-lg border border-gray-300 bg-white pl-9 px-3 text-sm text-gray-800 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none dark:border-gray-600 dark:bg-gray-900 dark:text-white"
                                    placeholder="0.00">
                            </div>
                        </div>
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <label class="mb-2 block text-sm font-semibold text-gray-700 dark:text-gray-300"><i
                class="ri-sticky-note-fill text-yellow-500"></i> Notas</label>
        <textarea name="notes" rows="3"
            class="w-full rounded-lg border border-gray-300 bg-yellow-50/30 px-4 py-3 text-sm text-gray-800 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 focus:outline-none dark:border-gray-600 dark:bg-gray-900 dark:text-white resize-none">{{ old('notes', data_get($recipe, 'notes')) }}</textarea>
    </div>
</div>
