...
>
    ...
    <div class="relative">
        ...
        <input
            ...
            class="h-11 w-full rounded-lg border border-gray-200 bg-white {{ $hideIcon ? 'pl-4' : 'pl-11' }} pr-10 text-sm text-gray-800 placeholder-gray-400 focus:border-[#C43B25] focus:ring-1 focus:ring-[#C43B25] dark:border-gray-700 dark:bg-dark-900 dark:text-white/90 transition-all"
            autocomplete="off"
        >
