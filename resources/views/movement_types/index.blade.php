    ...
    <div x-data="{}">
            ...
            <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                <form method="GET" class="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <x-ui.link-button size="sm" variant="outline" href="{{ route('admin.movement-types.index') }}">
                ...
                <x-ui.button size="md" variant="primary" type="button"
                    style=" background-color: #12f00e; color: #111827;" @click="$dispatch('open-movement-type-modal')">
                                    ...
                                    <div class="flex items-center justify-end gap-2">
                                        <div class="relative group">
                                            <x-ui.link-button
                                                size="icon"
                                                variant="edit"
                                                href="{{ route('admin.movement-types.edit', $movementType) }}"
                                        ...
                                        <form
                                            method="POST"
                                            action="{{ route('admin.movement-types.destroy', $movementType) }}"
        ...
        <x-ui.modal x-data="{ open: false }" @open-movement-type-modal.window="open = true" @close-movement-type-modal.window="open = false" :isOpen="false" :showCloseButton="false" class="max-w-3xl">
            <div class="p-6 sm:p-8">
                ...
                <form method="POST" action="{{ route('admin.movement-types.store') }}" class="space-y-6">
                    @csrf
