...
@section('content')
    <div x-data="{}">
                ...
                <table class="w-full min-w-max">
                    <thead>
                        <tr class="border-b border-gray-100 dark:border-gray-800">
                            <th style="background-color: #FF4622; color: #FFFFFF;" class="px-5 py-3 text-left sm:px-6 sticky-left-header">
                                <p class="font-medium text-white text-theme-xs dark:text-white">Descripcion</p>
                            </th>
                            <th style="background-color: #FF4622; color: #FFFFFF;" class="px-5 py-3 text-right sm:px-6">
        ...
        <x-ui.modal x-data="{ open: false }" @open-movement-type-modal.window="open = true" @close-movement-type-modal.window="open = false" :isOpen="false" class="max-w-3xl">
