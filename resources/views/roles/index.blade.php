        ...
        <x-common.component-card title="Listado de roles" desc="Gestiona los roles registrados en el sistema.">
            ...
            <div class="table-responsive mt-4 rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                <table class="w-full min-w-max">
                    <thead>
                        <tr class="text-white">
                            <th style="background-color: #FF4622; color: #FFFFFF;" class="px-3 py-3 text-center sm:px-6 first:rounded-tl-xl sticky-left-header">
                                        ...
                                        @foreach ($rowOperations as $operation)
                                            ...
                                            @if ($isDelete)
                                                ...
                                                >
                                                    ...
                                                    <span class="pointer-events-none absolute bottom-full left-1/2 -translate-x-1/2 mb-2 whitespace-nowrap rounded-md bg-gray-900 px-2 py-1 text-xs text-white opacity-0 transition group-hover:opacity-100 z-50" style="transition-delay: 0.3s;">{{ $operation->name }}</span>
                                                </form>
                                            @else
