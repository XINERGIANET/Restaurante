                            ...
                            el.innerHTML =
                                `
                                        ...
                                        <div class="${hasImg ? 'flex' : 'hidden sm:flex'} w-20 h-20 rounded-full bg-[#FF4622] items-center justify-center shrink-0 overflow-hidden mb-3">
                                            ${hasImg
                                    ? `<img src="${imageUrl}" alt="${productName}" class="w-full h-full rounded-full object-cover object-center" loading="lazy" onerror="this.onerror=null; this.parentElement.innerHTML='<i class=&quot;ri-restaurant-2-line text-2xl sm:text-3xl text-white&quot;></i>';">`
