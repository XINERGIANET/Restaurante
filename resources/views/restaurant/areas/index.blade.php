...
@section('content')
    ...
    <x-common.component-card title="Areas" desc="Gestiona las areas de la empresa.">
        <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            <form method="GET" class="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center">
                <div class="relative flex-1">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Buscar area"
                            ...
                            <div class="flex items-center justify-center gap-2">
                                <div class="relative group">
                                    <x-ui.link-button size="icon" variant="primary"
                                        href="{{ route('admin.areas.branches.index', [$area, 'icon' => 'ri-store-2-line']) }}"
                                    ...
                                    <span
                                        ...
                                        style="transition-delay: 0.5s;">Ver areas</span>
                                </div>
                                <div class="relative group">
                                ...
                                <form method="POST" action="{{ route('admin.areas.destroy', $area) }}"
                                    class="relative group js-swal-delete" data-swal-title="Eliminar area?"
                    ...
                    <tr>
                        <td colspan="4" class="px-6 py-12">
                            <div class="flex flex-col items-center gap-3 text-center text-sm text-gray-500">
                                ...
                                <p class="text-base font-semibold text-gray-700 dark:text-gray-200">No hay areas
                                    registradas.</p>
                                <p class="text-gray-500">Crea tu primera area para comenzar.</p>
    ...
    <x-ui.modal x-data="{ open: false }" @open-area-modal.window="open = true" @close-area-modal.window="open = false" :isOpen="false" :showCloseButton="false" class="max-w-xl">
        <div class="p-6 sm:p-8">
            <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center gap-4">
                    <p class="text-xs uppercase tracking-[0.3em] text-gray-400">Pedidos</p>
                    <h3 class="mt-2 text-lg font-semibold text-gray-800 dark:text-white/90">Registrar area</h3>
                </div>
            ...
            <form id="create-area-form" class="space-y-6" action="{{ route('admin.areas.store') }}" method="POST">
                @csrf
                ...
                <div class="grid gap-5 sm:grid-cols-1">
                    ...
                    <div>
                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                            Sucursal <span class="text-error-500">*</span>
                        </label>
                        <select 
                            name="branch_id" 
                            id="branch_id" 
