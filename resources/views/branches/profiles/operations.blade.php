...
@section('content')
    <div x-data="{}">
        ...
        <x-ui.modal x-data="{ open: false }" @open-assign-profile-operations.window="open = true" @close-assign-profile-operations.window="open = false" :isOpen="false" class="max-w-3xl">
