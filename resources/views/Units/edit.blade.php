        ...
        x-data="{
            ...
            close() {
                if (window.Turbo && typeof window.Turbo.visit === 'function') {
                    window.Turbo.visit('{{ route('admin.units.index') }}', { action: 'replace' });
                } else {
        ...
        <div class="p-6 sm:p-8">
            <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <a
                    ...
                    onclick="if (window.Turbo && typeof window.Turbo.visit === 'function') { window.Turbo.visit('{{ route('admin.units.index') }}', { action: 'replace' }); return false; }"
