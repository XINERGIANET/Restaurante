...
@section('content')
    <div x-data="{}">
                    ...
                    <tbody>
                        @forelse ($products as $product)
                            <tr class="border-b border-gray-100 transition hover:bg-gray-50 dark:border-gray-800 dark:hover:bg-white/5">
                                ...
                                <td class="px-5 py-4 sm:px-6">
                                    <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ $product->description }}</p>
                                </td>
                                <td class="px-5 py-4 sm:px-6">
                                    <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ $product->category?->description ?? '-' }}</p>
                                </td>
                                <td class="px-5 py-4 sm:px-6">
                                    <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ $product->baseUnit?->description ?? '-' }}</p>
                                </td>
                                <td class="px-5 py-4 sm:px-6">
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12">
                                    <div class="flex flex-col items-center gap-3 text-center text-sm text-gray-500">
                                        ...
                                        <p class="text-base font-semibold text-gray-700 dark:text-gray-200">No hay productos registrados.</p>
                                        <p class="text-gray-500">Crea el primer producto para comenzar.</p>
                                        <x-ui.button size="sm" variant="primary" type="button" @click="$dispatch('open-product-modal')">
                                            <i class="ri-add-line"></i>
        ...
        <x-ui.modal x-data="{ open: false }" @open-product-modal.window="open = true" @close-product-modal.window="open = false" :isOpen="false" :showCloseButton="false" class="max-w-5xl">
